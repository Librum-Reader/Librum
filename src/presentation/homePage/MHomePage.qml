...
Page {
    ...
    Item {
        ...
        anchors.left: foldersSidebar.right
        height: parent.height
        width: 64
    }
    ...
    Rectangle {
        ...
        Image {
            ...
            anchors.verticalCenter: parent.verticalCenter
            sourceSize.width: foldersSidebar.opened ? 25 : 20
            sourceSize.height: foldersSidebar.opened ? 25 : 20
            source: foldersSidebar.opened ? Icons.arrowheadBackIcon : Icons.folder
        }
