...
Item {
    ...
    Pane {
        ...
        DropArea {
            ...
            Image {
                ...
                source: root.currentImage.length
                        > 0 ? (root.currentImage
                               == "!" ? "" : root.currentImage) : UserController.profilePicture
    ...
    Image {
        ...
        visible: (deletePictureArea.containsMouse || mainArea.containsMouse)
                 && internal.imageExists
    ...
    QtObject {
        id: internal
        property bool imageExists: ((root.currentImage.length > 0)
