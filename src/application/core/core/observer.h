...
public:
    ...
    enum ChangedFlags
    {
        ...
        NeedSaveAs =
            64  ///< Set when "Save" is needed or annotation/form changes will
                ///< be lost @since 0.15 (KDE 4.9) @deprecated
    };
    ...
    /**
     * This method is called whenever the document is initialized or
     * reconstructed.
     *
     * @param pages The vector of pages of the document.
     * @param setupFlags the flags with the information about the setup
     */
    virtual void notifySetup(const QVector<Okular::Page*>& pages,
                             int setupFlags);
    ...
    /**
     * This method is called whenever the content described by the passed @p
     * flags has been cleared.
     */
