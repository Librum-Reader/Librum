...
{
public:
    virtual bool refreshInternalPageReferences(
        const QVector<Okular::Page*>& newPagesVector) = 0;
};

class AddAnnotationCommand : public OkularUndoCommand
{
public:
    AddAnnotationCommand(Okular::DocumentPrivate* docPriv,
                         Okular::Annotation* annotation, int pageNumber);
    ...
    bool refreshInternalPageReferences(
        const QVector<Okular::Page*>& newPagesVector) override;
...
{
public:
    RemoveAnnotationCommand(Okular::DocumentPrivate* doc,
                            Okular::Annotation* annotation, int pageNumber);
...
{
public:
    ModifyAnnotationPropertiesCommand(Okular::DocumentPrivate* docPriv,
...
public:
    ...
    Okular::NormalizedRect translateBoundingRectangle(
        const Okular::NormalizedPoint& delta);
...
{
public:
    EditTextCommand(const QString& newContents, int newCursorPos,
...
private:
    enum EditType
    {
        CharBackspace,  ///< Edit made up of one or more single character
                        ///< backspace operations
        CharDelete,  ///< Edit made up of one or more single character delete
                     ///< operations
        CharInsert,  ///< Edit made up of one or more single character insertion
                     ///< operations
        OtherEdit  ///< All other edit operations (these will not be merged
                   ///< together)
    };
...
public:
    EditAnnotationContentsCommand(Okular::DocumentPrivate* docPriv,
                                  Okular::Annotation* annotation,
                                  int pageNumber, const QString& newContents,
                                  int newCursorPos, const QString& prevContents,
...
public:
    EditFormTextCommand(Okular::DocumentPrivate* docPriv,
                        Okular::FormFieldText* form, int pageNumber,
...
{
public:
    EditFormListCommand(Okular::DocumentPrivate* docPriv, FormFieldChoice* form,
                        int pageNumber, const QList<int>& newChoices,
...
{
public:
    EditFormButtonsCommand(Okular::DocumentPrivate* docPriv, int pageNumber,
