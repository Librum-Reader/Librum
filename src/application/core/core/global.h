...
enum SearchDirection
{
    ...
    FromBottom,  ///< Searching from bottom of the page, next result is to be
                 ///< found, there was no earlier search result.
    NextResult,  ///< Searching for the next result on the page, earlier result
                 ///< should be located so we search from the last result not
                 ///< from the beginning of the page.
    PreviousResult  ///< Searching for the previous result on the page, earlier
                    ///< result should be located so we search from the last
                    ///< result not from the beginning of the page.
};
...
{
    MergeRight =
        0,  ///< Merge only if the right side of the first area intersect.
    MergeBottom =
        1,  ///< Merge only if the bottom side of the first area intersect.
    MergeLeft =
        2,  ///< Merge only if the left side of the first area intersect.
