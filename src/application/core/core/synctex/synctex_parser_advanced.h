...
extern "C"
{
     ...
     * to friend. A friend is a node with very close tag and line numbers.
    ...
    typedef enum
    {
        ...
        synctex_node_mask_void_hbox = synctex_mask_no_root | synctex_mask_void |
                                      synctex_mask_box | synctex_mask_no_proxy |
                                      synctex_mask_h,
        synctex_node_mask_vbox_proxy = synctex_mask_no_root |
                                       synctex_mask_no_void | synctex_mask_box |
                                       synctex_mask_proxy | synctex_mask_v,
        synctex_node_mask_hbox_proxy = synctex_mask_no_root |
                                       synctex_mask_no_void | synctex_mask_box |
                                       synctex_mask_proxy | synctex_mask_h,
    ...
    synctex_node_p synctex_node_new(synctex_scanner_p scanner,
    ...
    void synctex_scanner_set_display_switcher(synctex_scanner_p scanR,
                                              int switcher);
     ...
     *  Objects are handles to nodes in the synctex node tree starting at
     * scanner.
     */
     ...
     *      }
     */
    synctex_iterator_p synctex_iterator_new_display(synctex_scanner_p scanner,
     ...
     *      }
     */
    synctex_iterator_p synctex_iterator_new_edit(synctex_scanner_p scanner,
                                                 int page, float h, float v);
    /**
     ...
     *  free the updater */
    synctex_updater_p synctex_updater_new_with_output_file(
    ...
    void synctex_updater_append_magnification(synctex_updater_p updater,
                                              char* magnification);
    void synctex_updater_append_x_offset(synctex_updater_p updater,
                                         char* x_offset);
    void synctex_updater_append_y_offset(synctex_updater_p updater,
                                         char* y_offset);
    ...
    void synctex_updater_free(synctex_updater_p updater);
        ...
        #warning TESTING IS PROHIBITED
            ...
            #define __PRAGMA_PUSH_NO_EXTRA_ARG_WARNINGS   \
                _Pragma("clang diagnostic push") _Pragma( \
                    "clang diagnostic ignored \"-Wformat-extra-args\"")
        ...
        #define SYNCTEX_TEST_PARAMETER(counter, condition)            \
            SYNCTEX_TEST_BODY(counter, (condition),                   \
