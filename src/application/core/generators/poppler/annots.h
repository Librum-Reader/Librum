...
extern Okular::Annotation* createAnnotationFromPopplerAnnotation(
...
public:
    ...
    void notifyModification(const Okular::Annotation* okl_ann, int page,
                            bool appearanceChanged) override;
...
private:
    ...
    std::unordered_map<Okular::StampAnnotation*,
                       std::unique_ptr<Poppler::AnnotationAppearance>>
