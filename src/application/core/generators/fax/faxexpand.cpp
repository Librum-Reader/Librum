...
static void unexpected(const char* what, int LineNum)
{
    ...
    {
        qCCritical(FAX_LOG)
            << "Line " << LineNum << ": Unexpected state in " << what;
    }
}
...
void MHexpand(pagenode* pn, drawfunc df)
{
    ...
    for(LineNum = 0; LineNum < pn->rowsperstrip;)
    {
        ...
        if(a0 != lastx)
        {
            if(verbose)
            {
                qCWarning(FAX_LOG) << "Line " << LineNum << ": length is " << a0
                                   << " (expected " << lastx << ")\n";
            }
            while(a0 > lastx)
            {
...
void g31expand(pagenode* pn, drawfunc df)
{
    ...
    for(LineNum = 0; LineNum < pn->rowsperstrip;)
    {
        ...
        {
            qCCritical(FAX_LOG)
                << "Line " << LineNum << ": bad RTC (" << EOLcnt << " EOLs)\n";
        }
...
static const unsigned char zerotab[256] = {
    
};
